...
/**
 * @notice The newen token
 * @custom:security-contact jp@anky.lat
 */
contract NewenToken is
    ERC20,
    ERC20Burnable,
    ERC20Pausable,
    ERC20Permit,
    ...
    Ownable
{
     ...
     */
    string public constant TOKEN_NAME = "Newen";

    /**
     * @dev EIP-20 token symbol for this token
     */
    string public constant TOKEN_SYMBOL = "NEWEN";

    /**
     * @dev Total number of tokens in circulation
     */
    uint256 public constant TOKEN_INITIAL_SUPPLY = 1_618_033_969;
     ...
     */
    error NewenMintCapExceeded();

    /**
     * @dev Construct a new Newen token
